	...
	public function advshowOp(){
		...
		if($ap_class == '2'){
			...
			if(empty($data_select)){
				...
				$content .= "<a href='' target='_blank'><img src='".$pic."' alt='幻灯片默认广告图片' width='".$ap_width."' height='".$ap_height."' /></a>";
				...
				$content .= "document.write(\"<ul class='ul-banimg slides'>";
				...
				foreach ($data as $k=>$v){
				    ...
				    if(file_exists($adv_cache_file)){
						...
						$url = "http://".$pic_content['adv_slide_url'];
						...
						if($k == 0){
							...
							$content .= "<li><a target='_blank' href='".$url."'><img src='".$pic."' alt='' /></a></li>";
						}else{
							$content .= "<li style='display:none;'><a target='_blank' href='".$url."'><img src='".$pic."' alt='' /></a></li>";
						}
			...
			switch ($ap_display){
				...
				foreach ($data as $k=>$v){
			        ...
			        if(empty($data_select)){
			        	...
			        	switch ($ap_class){
			        		...
			        		case '0':
			        			...
			        			$content .= "document.write(\"<a href='' target='_blank'>";
			        		...
			        		case '1':
			        			...
			        			$content .= "document.write(\"<a target='_blank' href=''>";
			       ...
			       if($ap_class == '0' && $is_use == '1'){
						...
						$content .= "document.write(\"<a target='_blank' href='".SiteUrl.DS."index.php?act=advclick&op=advclick&adv_id=".$adv_id."&ap_class=".$ap_class."' target='_blank'>";
			       ...
			       if($ap_class == '1' && $is_use == '1'){
					...
					if($ap_class == '3' && $is_use == '1'){
						...
						$content .= "document.write(\"<a target='_blank' href='".$url."' target='_blank'><button style='width:".$width."px; height:".$height."px; border:none; padding:0; background:none;' disabled><object id='FlashID' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='".$width."' height='".$height."'>";
				...
				foreach ($data as $k=>$v){
					...
					if($ap_class == '3' && $is_use == '1' && $is_allow == '1'){
						...
						$content .= "document.write(\"<a target='_blank' href='http://".$url."' target='_blank'><button style='width:".$width."px; height:".$height."px; border:none; padding:0; background:none;' disabled><object id='FlashID' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='".$width."' height='".$height."'>";
