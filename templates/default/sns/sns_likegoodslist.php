...
<div class="tabmenu">
  <ul class="tab">
    <li class="normal"><a href="index.php?act=member_snshome&op=shareglist&type=share&mid=<?php echo $output['member_info']['member_id'];?>"><?php echo $lang['sns_shareofgoods'];?></a></li>
    <li class="active"><i></i><a href="index.php?act=member_snshome&op=shareglist&type=like&mid=<?php echo $output['member_info']['member_id'];?>"><?php echo $lang['sns_likeofgoods'];?></a></li>
  </ul>
...
<ul class="handle">
  <?php if ($output['relation'] == 3){?><li class="delete" style=" margin-left: 150px;" nc_type="delbtn" data-param='{"sid":"<?php echo $v['share_id'];?>","tabtype":"like"}'><a href="javascript:void(0)"><i></i><?php echo $lang['nc_delete'];?></a></li>
    <?php } ?></ul>
  <dl>
    <dt class="goodspic"><span class="thumb size233"><i></i><a href="index.php?act=member_snshome&op=goodsinfo&type=like&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>"> <img src="<?php echo cthumb($v['snsgoods_goodsimage'],'240x240',$v['snsgoods_storeid']);?>"/> </a></span></dt>
