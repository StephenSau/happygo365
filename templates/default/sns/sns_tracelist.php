...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt><img src="<?php if ($v['trace_memberavatar']!='') { echo ATTACH_AVATAR.DS.$v['trace_memberavatar']; } else {  echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>"><h3><a href="index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"><?php echo $v['trace_membername'];?><?php echo $lang['nc_colon'];?></a><?php echo parsesmiles($v['trace_title']);?></h3>
