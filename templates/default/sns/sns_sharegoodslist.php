...
<div class="sns-main-all">
  <div class="tabmenu"><?php if($output['relation'] == '3'){?>
    ...
    <?php }?>
    <ul class="tab">
      <li class="active"><i></i><a href="index.php?act=member_snshome&op=shareglist&type=share&mid=<?php echo $output['member_info']['member_id'];?>"><?php echo $lang['sns_shareofgoods'];?></a></li>
      <li class="normal"><i></i><a href="index.php?act=member_snshome&op=shareglist&type=like&mid=<?php echo $output['member_info']['member_id'];?>"><?php echo $lang['sns_likeofgoods'];?></a></li>
    </ul>
  ...
  <div class="sharelist-g mt30">
    ...
    <ul class="nc-sns-pinterest" id="snsPinterest">
      ...
      <li id="recordone_<?php echo $v['share_id'];?>" class="item">
        ...
        <dl>
          <dt class="goodspic"><span class="thumb size233"><i></i><a href="index.php?act=member_snshome&op=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>"> <img src="<?php echo cthumb($v['snsgoods_goodsimage'],'240x240',$v['snsgoods_storeid']);?>"/></a></span>
    ...
    <div class="sns-norecord"><i class="goods-ico pngFix"></i><span><?php echo $lang['sns_sharegoods_nothave_self_1'];?><a href="index.php?act=member&op=order" target="_blank"><?php echo $lang['sns_sharegoods_nothave_self_2'];?></a><?php echo $lang['sns_sharegoods_nothave_self_3'];?><a href="index.php?act=member_favorites&op=fglist" target="_blank"><?php echo $lang['sns_sharegoods_nothave_self_4'];?></a><?php echo $lang['sns_sharegoods_nothave_self_5'];?></span></div>
    <?php }else {?>
