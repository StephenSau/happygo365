...
<div class="left-content"> 
  ...
  <ul class="sns-home-share">
    ...
    <li id="recordone_<?php echo $v['share_id'];?>"><a href="index.php?act=member_snshome&op=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>" class="pic" style=" background-image:url(<?php echo cthumb($v['snsgoods_goodsimage'],'240x240',$v['snsgoods_storeid']);?>)"> </a>
        ...
        <div class="shop-content">
          ...
          <div class="detail">
            ...
            <ul nc_type="mycarousel" class="jcarousel-skin-tango">
              ...
              <li><a href="<?php echo $g_v['goodsurl'];?>" target="_blank" style=" background-image: url(<?php echo thumb($g_v,'small');?>)" title="<?php echo $g_v['goods_name'];?>">&nbsp;</a></li>
              <?php }?>
            </ul>
            <?php }?>
          </div>
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt><img src="<?php if ($v['trace_memberavatar']!='') { echo ATTACH_AVATAR.DS.$v['trace_memberavatar']; } else {  echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>">
          <h3><a href="index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"><?php echo $v['trace_membername'];?><?php echo $lang['nc_colon'];?></a><?php echo parsesmiles($v['trace_title']);?></h3>
        </dt>
        <dd>
        ...
        <dd>
          ...
          <span class="fl ml10"><?php 
        	switch ($v['trace_from']){
        		case '1':
        		case '2':
        			echo $lang['sns_from'].'<a target="_black" href="'.SiteUrl.'">'.$lang['sns_shop'].'</a>';
        			break;
        		case '3':
        			echo $lang['sns_from'].'<a target="_black" href="'.getMicroshopUrl().'">'.$lang['nc_modules_microshop'].'</a>';
        			break;
        	}
          ?></span>
