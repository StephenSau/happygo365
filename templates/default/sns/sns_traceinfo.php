...
<ul class="fd-list">
  ...
  <li nc_type="tracerow_<?php echo $output['traceinfo']['trace_id']; ?>">
    <dl class="fd-wrap">
      <dt><a href="index.php?act=member_snshome&mid=<?php echo $output['traceinfo']['trace_memberid'];?>" target="_blank"> <img src="<?php if ($output['traceinfo']['trace_memberavatar']!='') { echo ATTACH_AVATAR.DS.$output['traceinfo']['trace_memberavatar']; } else {  echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>"> </a>
        <h3><a href="index.php?act=member_snshome&mid=<?php echo $output['traceinfo']['trace_memberid'];?>" target="_blank"><?php echo $output['traceinfo']['trace_membername'];?><?php echo $lang['nc_colon'];?></a><?php echo $output['traceinfo']['trace_title'];?></h3>
      ...
      <dd>
        <span class="goods-time fl"><?php echo date('Y-m-d h:i',$output['traceinfo']['trace_addtime']);?></span>
          <span class="fl ml10"><?php 
        	switch ($output['traceinfo']['trace_from']){
        		case '1':
        		case '2':
