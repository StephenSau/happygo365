...
<div class="comment-widget">
  ...
  <ul class="comment-list">
    ...
    <li nc_type="commentrow_<?php echo $v['scomm_id']; ?>"> <a target="_blank" href="index.php?act=member_snshome&mid=<?php echo $v['scomm_memberid'];?>"><img width="30" height="30" class="clogo" src="<?php if ($v['scomm_memberavatar']!='') { echo ATTACH_AVATAR.DS.$v['scomm_memberavatar']; } else {  echo ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,30,30);"></a>
      <div class="detail">
  ...
  <?php if ($output['showtype']==1 && $output['showmore'] == '1'){?>
