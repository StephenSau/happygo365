  	...
  	<div class="fd-aside">
		<span class="thumb size60"><i></i>
			<a href="index.php?act=store_snshome&sid=<?php echo $output['strace_info']['strace_storeid'];?>" target="_blank">
				<img src="<?php echo $output['strace_info']['strace_storelogo']!='' ? ATTACH_STORE.DS.$output['strace_info']['strace_storelogo'] : ATTACH_COMMON.DS.C('default_store_logo');  ?>" onload="javascript:DrawImage(this,60,60);">
			</a>
		</span>
      </div>
    <dl class="fd-wrap">
				...
				<div class="forward-edit">
					<form id="forwardform_<?php echo $output['strace_info']['strace_id'];?>" method="post" action="index.php?act=store_snshome&op=addforward">
						...
						<div class="forward-add">
							...
							<div id="forwardseccode<?php echo $output['strace_info']['strace_id'];?>" class="seccode">
