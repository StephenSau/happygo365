...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li nc_type="tracerow_<?php echo $val['strace_id']; ?>">
      <div class="fd-aside"> <span class="thumb size60"><i></i> <a href="index.php?act=store_snshome&sid=<?php echo $val['strace_storeid'];?>" target="_blank"> <img src="<?php echo $val['strace_storelogo']!='' ? ATTACH_STORE.DS.$val['strace_storelogo'] : ATTACH_COMMON.DS.C('default_store_logo');  ?>" onload="javascript:DrawImage(this,60,60);"> </a> </span> </div>
      <dl class="fd-wrap">
        <dt>
