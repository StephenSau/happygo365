    ...
    <div class="module_filter">
      <div class="module_filter_line">
        ...
        <dl <?php if($dl>3){?>class="dl_hide"<?php }?>>
          ...
          <dd class="list">
            <ul>
              ...
              <li <?php if ($i>10){?>style="display:none" nc_type="none"<?php }?>><a href="javascript:replaceParam('b_id','<?php echo $_GET['b_id'] != ''?$_GET['b_id'].','.$k:$k;?>');"><?php echo $v['name'];?></a></li>
              <?php }?>
            </ul>
          </dd>
        ...
        <dd class="list">
          <ul>
            <?php $i = 0;foreach ($val['value'] as $k=>$v){$i++?>
            <li <?php if ($i>10){?>style="display:none" nc_type="none"<?php }?>><a href="javascript:replaceParam('a_id','<?php echo $_GET['a_id'] != ''?$_GET['a_id'].','.$k:$k;?>');"><?php echo $v['name'];?></a></li>
            <?php }?>
          </ul>
        </dd>
        <?php if (count($val['value']) > 10){?>
