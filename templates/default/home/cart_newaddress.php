...
<div style="height:auto;">
  ...
  <ul class="fill_in_content">
    ...
    <li>
      ...
      <p class="fill_in">
        <input type="text" name="consignee" maxlength="20" id="consignee" class="text1 formvalidatedata" value=""/>
        <span class="field_message explain"> <span class="field_notice"><?php echo $lang['cart_step1_true_name'];?></span>
    ...
    <li>
      ...
      <p class="fill_in">
        <input type="text" name="address" id="address" maxlength="80" class="text1 formvalidatedata" style="width:300px;" value=""/>
    ...
    <li>
      ...
      <p class="fill_in">
        <input type="text" name="zipcode" id="zipcode" class="text1" maxlength="6" value=""/>
    ...
    <li>
      ...
      <p class="fill_in">
        <input type="text" name="phone_tel" id="phone_tel" maxlength="20" class="text1 formvalidatedata" value=""/>
        </p>
    </li>
	<br/>
    <li>
        <p class="title">
          <span style="color:red;">*</span><?php echo $lang['cart_step1_mobile_num'];?>
        </p>
        <p class="fill_in">
            <input type="text" id="phone_mob" name="phone_mob" maxlength="11" class="text1 formvalidatedata" value=""/>
            <span class="field_message explain"> <span class="field_notice"><?php echo $lang['cart_step1_telphoneormobile'];?>
            </span><label class="error" generated="true"></label></span>
        </p>

    </li>
    <br/>
	<li>
      <p class="title"><span>*</span><?php echo $lang['cart_step1_card_num'];?></p>
      <p class="fill_in">
        <input type="text" name="card" id="card" class="text1" value="" maxlength="18" />
        <span class="field_message explain"><span class="field_notice"></span>
        <label class="error" generated="true"></label>
        </span></p>
    </li>
...
function submitaddress(){
    ...
    if($("#card").parents("li").is(":visible")){
        if(card == ''){
            showerror($("#card"),'<?php echo $lang['cart_step1_input_card1'];?>');
            if(result == true){
                result = false;
            }
        }

    	if (!/^(\d{18,18}|\d{15,15}|\d{17,17}X)$/.test(card)){
    		showerror($("#card"),'请填写正确的身份证格式');
    		if(result == true){
    			result = false;
    		}
    	}
	...
	$("#card").blur(function()
	{
		if($(this).val()!=='' && /^(\d{18,18}|\d{15,15}|\d{17,17}x)$/.test($(this).val()))
		{
	...
	if(result == true){
		//提交表单
		var datastr = {'consignee':consignee,'areaid':areaid_hidden,'city_id':city_id,'area_info':area_info,'address':address,'zipcode':zipcode,'phone_tel':phone_tel,'phone_mob':phone_mob,'card':card,'form_submit':'ok'}
