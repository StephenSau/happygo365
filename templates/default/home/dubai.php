...
.embassy{position:relative;width:100%;height:447px;margin : 0 auto -30px;overflow: hidden;}
.embassy img {position: absolute;left:50%;margin-left: -960px;}
.dubaiBg {background: url("templates/default/images/banner_bg/dubai_bg.jpg") center 447px repeat transparent;}
</style>


<div class="content dubaiBg">
		<div class="maxad embassy" id="banner">
			...
			<a><img style="width:1920px;height:447px" border="0" src="templates/default/images/banner_bg/dubai_banner.png" alt=""></a>
		</div>
		<div class="w1210">
			<div class="koreatj">
				<!--迪拜馆商品分类begin-->
		...
		<!-- 迪拜广告 -->
		<div class="fixedAdv"><a href="index.php?act=dubai_powder" target="_blank"><img src="templates/default/images/adv/dubai_adv.jpg" alt="" width="142" height="125" /></a></div>
	</div>