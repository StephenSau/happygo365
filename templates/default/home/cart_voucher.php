...
<dl class="cart-discount">
  ...
  <dd>
    ...
    <div>
      ...
      <input type="radio" value="0" name="voucher_id" onclick="showval(0)" rel="voucher" checked>
    ...
    <div title="<?php echo $lang['cart_step1_voucher_usecondition'].$voucher['voucher_limit'].$lang['currency_zh'].$lang['cart_step1_voucher'].$lang['nc_colon'].$voucher['voucher_code'];?>">
      ...
      <input type="radio" value="<?php echo $voucher['voucher_id'];?>" name="voucher_id" id="voucher_id"  rel="voucher" onclick="showval(<?php echo ncPriceFormat($voucher['voucher_price']);?>)">
