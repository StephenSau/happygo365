...
<!-- 添加Banner广告图 -->
		<div class="taiwan_museum_ben_di"><p><img src="templates/default/images/banner_bg/dubai_museum_benner.jpg"></p></div>
	</div>
...
<div class="taiwan_museum_main">
    ...
    <?php if($topgoods){?>
		<div class="taiwan_museum_submenu">
			...
			<div class="taiwan_museum_r"><a href="index.php?act=dubai&op=list">MORE&nbsp;&nbsp;></a></div>
		</div>
