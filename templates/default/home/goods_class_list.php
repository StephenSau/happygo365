  ...
  <ul class="list_pic">
    ...
    <li class="item">
      ...
      <dl nctype_goods="<?php echo $goods['goods_id'];?>" nctype_store="<?php echo $goods['store_id'];?>">
        ...
        <dd class="comment"><span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id']),'goods',$goods['store_domian']);?>#ncGoodsRate"><?php echo $lang['goods_class_index_comment'];?><?php echo $goods['commentnum'];?><?php echo $lang['goods_class_index_number_of_consult'];?></a></span></dd>
