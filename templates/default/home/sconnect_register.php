...
<div class="nc-login-layout">
  ...
  <div class="nc-login" id="rotate">
    <ul>
      <li><a href="#register_form"><span><?php echo $lang['home_sconnect_register_title']; ?></span></a></li>
      <li><a href="#log_form"><span><?php echo $lang['home_sconnect_login_title']; ?></span></a></li>
    </ul>
      ...
      <form name="register_form" id="register_form" method="post" action="index.php?act=sconnect&op=register">
        ...
        <dl>
          ...
          <dd>
            ...
            <span for="agreebbrule" class="fl"><?php echo $lang['home_sconnect_login_agree'];?> 
            <a target="_blank" href="index.php?act=document&amp;code=agreement"><?php echo $lang['home_sconnect_login_useragreement']; ?></a></span>
            <label></label>
          </dd>
        </dl>
      </form>
