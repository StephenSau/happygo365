      ...
      <dl nctype_goods="<?php echo $goods['goods_id'];?>" nctype_store="<?php echo $goods['store_id'];?>">
        ...
        <dd class="seller-intro">
          ...
          <ul>
            ...
            <li><span><?php echo $lang['brand_index_goods_evaluate'].$lang['nc_colon'];?></span><span><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$goods['goods_id']),'goods',$goods['store_domian']);?>#ncGoodsRate"><?php echo $lang['brand_index_comment'];?><?php echo $goods['commentnum'];?><?php echo $lang['brand_index_number_of_consult'];?></a></span></li>
