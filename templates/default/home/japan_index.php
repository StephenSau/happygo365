...
<!-- 添加Banner广告图 -->
		<div class="taiwan_museum_ben_di"><p><img src="templates/default/images/banner_bg/japan_museum_benner.jpg"></p></div>
	</div>
...
<div class="taiwan_museum_main">
    ...
    <?php if($topgoods){?>
		<div class="taiwan_museum_submenu">
			...
			<div class="taiwan_museum_r"><a href="index.php?act=japan&op=list">MORE&nbsp;&nbsp;></a></div>
		</div>
		<div class="taiwan_explosion_product">
			<ul>
            <?php foreach($topgoods as $key=>$val){?>
				<li>
					<a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']?>">
						...
						<div class="taiwan_exp_div">
							<div class="taiwan_info">
								<p class="taiwan_exp_tit"><?php echo mb_substr($val['goods_name'],0,20,"utf-8")."..."?></p>
			...
			<ul>
				...
				<li>
					...
					<div class="taiwan_new_div">
						<div class="taiwan_info">
							<p class="taiwan_new_tit"><?php echo mb_substr($val['goods_name'],0,10,"utf-8")."..."?></p>
		...
		<div  class="taiwan_common_pro">
			<ul>
				...
				<li>
					<a target="_blank" href="index.php?act=goods&goods_id=<?php echo $valsec['goods_id']?>">
						<span class="taiwan_common_num"><i><?php echo round(($valsec['spec_goods_price']/$valsec['spec_market_price']*10),2);?>折</i></span>
						...
						<div class="taiwan_common_div">
							<div class="taiwan_info">
								<p class="taiwan_common_tit"><?php echo mb_substr($valsec['goods_name'],0,10,"utf-8")."..."?></p>
