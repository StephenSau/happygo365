...
<div class="buywantsite">
  <div class="cart-title buywantsitetop">
    <h3><?php echo $lang['cart_step1_receiver_address'];?></h3>
    <p><a href="JavaScript:void(0);" id="span_newaddress" onclick="shownewaddress();" class="newadd a-newbuywantsite"><span><?php echo $lang['cart_step1_new_address']; ?></span></a> <a href="index.php?act=member&op=address" target="_blank" class="editadd a-managebuywantsite"><span><?php echo $lang['cart_step1_manage_receiver_address'];?></span></a></p>
    </span>
  </div>
  ...
  <div id="addresslist" class="mb30 buywantsitemain">
