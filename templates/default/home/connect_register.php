...
<div class="nc-login-layout">
  ...
  <div class="nc-login" id="rotate">
    <ul>
      <li><a href="#register_form"><?php echo $lang['home_qqconnect_register_title']; ?></a></li>
      <li><a href="#log_form"><?php echo $lang['home_qqconnect_login_title']; ?></a></li>
    </ul>
      ...
      <form name="register_form" id="register_form" method="post" action="index.php?act=connect&op=register">
        ...
        <dl>
          ...
          <dd>
            ...
            <span for="agreebbrule" class="fl"><?php echo $lang['home_qqconnect_login_agree'];?> 
            <a target="_blank" href="index.php?act=document&amp;code=agreement"><?php echo $lang['home_qqconnect_login_useragreement']; ?></a></span>
            <label></label>
          </dd>
        </dl>
      </form>
