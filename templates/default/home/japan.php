...
.embassy{position:relative;width:100% ;height:432px;margin : 0 auto;overflow: hidden;}
.embassy img {position: absolute;left:50%;margin-left: -960px;}
.japanBg {background: url("templates/default/images/banner_bg/japan_bg.jpg") center 432px repeat transparent;}
</style>



<div class="content japanBg">
		<div class="maxad embassy" id="banner">
			<!--<script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=396"></script>-->
			<a><img style="width:1920px;height:432px" border="0" src="templates/default/images/banner_bg/japan_banner.jpg" alt=""></a>
		</div>
		<div class="w1210">
			<div class="koreatj">
				<!--
				<ul class="ul-koreatj font-mic">
					...
					<li <?php if($key == 0){echo "class='nomargin-l'";}?>>
						...
						<a href="<?php echo SiteUrl;?>/index.php?act=japan&id=2&a=#<?php echo (int)$value['gc_id']?>"><b><?php echo $value['gc_name']?></b>东京</a>
					</li>					
					<?php }$num++;}}?>
				</ul>
				-->
			...
			<div class="goodslist pdt40">
				<div class="goodslisttitle">
					<h2><?php echo $val['gc_name']?><span>（东京）</span><a href="#" name="<?php echo (int)$val['gc_id'];?>"></a></h2>
				</div>
