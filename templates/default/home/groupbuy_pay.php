...
<div class="content">
<form action="index.php?act=payment&order_id=<?php echo $output['order_id']; ?>" method="POST" id="goto_pay" onsubmit="return false;">
  <div class="cart-order-info">
    <div class="title"><span class="all-goods-name"><?php echo $output['goods_name'];?></span><span class="goto-order"><a href="index.php?act=member&op=show_order&order_id=<?php echo $output['order_id']; ?>" target="_blank"><?php echo $lang['cart_step2_order_info'];?></a></span><span class="refresh"><?php echo $lang['cart_step2_order_refresh_tip'];?><a href="javascript:void(0);" id="refresh"><?php echo $lang['cart_step2_order_refresh'];?></a></span><span class="order-price" title="<?php echo $lang['cart_step2_prder_price'];?>"><?php echo $output['order_amount']; ?></span></div>
    <div class="intro">
      <dl>
      ...
      <dl>
        ...
        <dd><?php echo date('Y-m-d:H:i:s',TIMESTAMP);?></dd>
      </dl>
    </div>
  </div>
  <div class="cart-order-pay">
    ...
    <div class="tabs-panel">
      <ul class="cart-defray">
        ...
        <li>
          <label class="radio">
            <input id="payment_<?php echo $val['payment_code']; ?>" type="radio" name="payment_id" value="<?php echo $val['payment_id']; ?>" />
          </label>
          <span class="logo"><img src="api/payment/<?php echo $val['payment_code']; ?>/logo.gif" alt="<?php echo $val['payment_name']; ?>-<?php echo $val['payment_info']; ?>" title="<?php echo $val['payment_name']; ?>-<?php echo $val['payment_info']; ?>" width="125" height="47" /></span>
          <dl class="explain">
            <dt></dt>
    ...
    <div class="tabs-panel <?php if (empty($output['online_array']) && !empty($output['offine_array'])){}else{?>tabs-hide<?php }?>">
      <ul class="cart-defray">
        ...
        <?php if( $val['payment_code'] == 'cod' && !$output['is_cod'] ) continue; ?>
        <li>
          <label class="radio">
      ...
      <div class="cart-paymessage" id="paymessagediv" style="display:none"><?php echo $lang['cart_step2_paymebankinfo'];?>
        <dl>
    ...
    <?php if(empty($output['offine_array']) && empty($output['online_array'])){?>
    <div  class="ml50 mb30" style="font-weight: 600;color: red;font-size:14px;padding-top:21px"><?php echo $lang['cart_step2_paymentnull_1']; ?>
      <?php if (C('payment')){?>
