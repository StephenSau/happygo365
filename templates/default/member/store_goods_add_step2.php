...
<link rel="stylesheet" type="text/css" href="<?php echo TEMPLATES_PATH;?>/css/addfunction.css"  />
<style>
...
//            },
            ...
            store_base : {
				required: '<?php echo $lang['store_goods_index_stock_base_null'];?>',
                digits  : '<?php echo $lang['store_goods_index_stock_base_error'];?>',
                min		: '<?php echo $lang['store_goods_index_stock_base_min'];?>',
                max		: '<?php echo $lang['store_goods_index_stock_base_max'];?>'
            },
            py_price	:{
...
<div class="wp">
  <div class="item-publish">
    <form method="post" id="goods_form" enctype="multipart/form-data" action="index.php?act=store_goods&op=<?php if ($output['goods']['goods_id']!='') echo 'edit_save_goods'; else echo 'save_goods'; ?>">
      ...
      <input type="hidden" name="tax_money" value="<?php if($output['tax_money']){ echo $output['tax_money'];}else{echo $output['good_info']['goods_tax'];} ?>" />
      <input type="hidden" name="tax_num" value="<?php if($output['tax_num']){ echo $output['tax_num'];}else{echo $output['good_info']['goods_tax_num'];} ?>" />  
      <input type="hidden" name="spec_id" value="<?php echo $output['goods']['spec_id'];?>"/>
      <input type="hidden" name="cate_id" value="<?php if($output['second_category']){ echo $output['second_category'];}else{echo $output['good_info']['gc_id'];} ?>" />
      <input type="hidden" name="country" value="<?php if($output['goods_country']){ echo $output['goods_country'];}else{echo $output['good_info']['country'];} ?>" />
      <input type="hidden" name="type_id" value="<?php echo $output['goods_class']['type_id'];?>" />
      <input type="hidden" name="provider" value="<?php if($output['goods_provider']){ echo $output['goods_provider'];}else{echo $output['good_info']['provider'];} ?>" />
      <div class="goods-attribute">
        ...
        <dl>
          ...
          <dd id="gcategory">
            ...
            <span class="f_l"><?php echo $output['goods_class']['gc_tag_name'];?></span> <a class="edit_gcategory ml10" href="index.php?act=store_goods&op=add_goods&step=one&goods_id=<?php echo $output['goods']['goods_id']?>"><span><?php echo $lang['nc_edit'];?></span></a>
            <?php } else { ?>
            <span class="f_l"><?php echo $output['goods_class']['gc_tag_name'];?></span> <a class="edit_gcategory ml10" href="index.php?act=store_goods&op=add_goods&step=one&id=<?php echo $_GET['id'] ?>"><span><?php echo $lang['nc_edit'];?></span></a>
            <?php } ?>
        ...
        <dl>
          ...
          <dd>
            <p>
              ...
              <input name="goods_name" type="text" class="text w400" title="" value="<?php echo !empty($output['good_info']['goods_name']) ? $output['good_info']['goods_name'] : $output['goods_name'];?>" />
            <p>
            <p class="hint"><?php echo $lang['store_goods_index_goods_name_help'];?></p>
                    ...
                    <dl>
						 <dt class="required"><span class="red">*</span><?php echo $lang['store_goods_index_store_price'].$lang['nc_colon'];?></dt>
                        ...
                        <dd>
							...
							<input name="goods_store_price" value="<?php echo !empty($output['good_info']['goods_store_price']) ? $output['good_info']['goods_store_price'] : $output['declaration_price'];?>" type="text" id="texts10" class="text" />

							<input name="goods_store_price_interval" value="<?php echo !empty($output['good_info']['goods_store_price_interval']) ? $output['good_info']['goods_store_price_interval'] : $output['goods_store_price_interval'];?>" type="hidden"  />
      ...
      <!--  <dl>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="spec_table">
              ...
              <th><?php echo $val['sp_name'];?></th>
                ...
                <th><?php echo $lang['store_goods_index_goods_no'];?></th>
                 <th><?php echo $lang['store_market_price'];?></th>
                  </thead>
        ...
        <!--汽配-->
        <dl>
          <dt nc_type="no_spec" ><?php echo $lang['store_goods_car_accessory'].$lang['nc_colon'];?></dt>
          <dd nc_type="no_spec">
            <p>
              <input name="car_accessory"  value="<?php echo $output['goods']['car_accessory']; ?>" type="text"  class="text"  />
            </p>
            <!--<p class="hint"><?php echo $lang['store_goods_index_goods_no_help'];?></p>-->
          </dd>
        </dl>
        ...
        <!--4s价格-->
        <dl>
          <dt nc_type="no_spec" ><?php echo $lang['store_goods_four_s_price'].$lang['nc_colon'];?></dt>
          <dd nc_type="no_spec">
            <p>
              <input name="four_s_price"  value="<?php echo $output['goods']['four_s_price']; ?>" type="text"  class="text"  />
            </p>
             <!--<p class="hint"><?php echo $lang['store_goods_index_goods_no_help'];?></p>-->
          </dd>
        </dl>
         <!--4s价格end-->
          ...
          <!--商品明细-->
                  ...
                  <dl id="detaillists" style=" display: none;">
                      <dt nc_type="no_spec"  ><?php echo $lang['store_goods_detail'];?></dt>
					  
                      <dd nc_type="no_spec" id="mingxiarr" style="width:200px;">
						<?php if(is_array($car_detail) && !empty($car_detail)){$i=0;?>
                       		 <?php foreach($car_detail as $key=>$val){?>
                        <!--<p>
                         <textarea rows="10" style="width:300px;" name="d_specids[]"><?php echo unserialize($spec_value[$i]['spec_d_specvalue']); ?></textarea>
                        </p>-->
                        
                        <div  class="qqqqqqqqqqqqqq custom_containers<?php echo $key?>">
						<?php echo $val[1]['specstr']?>
                            <div class="wwwwwwwwwwwwwwwwww custom_displays<?php echo $key?>">
                                    <dl >
                                        <dt><input type="button" class="custom_reduce custom_reduces<?php echo $key?>" value="-"></input></dt>
                                        <dd>
                                            <ul>
                                                <li><input type="text" name="c_details[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_nums[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_prices[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_omodels[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_rbrands[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_rmodels[<?php echo $key?>][]" value=""></li>
                                                <li><input type="text" name="c_costs[<?php echo $key?>][]" value=""></li>
                                    ...
                                    <dl>  
                                        ...
                                        <dt><input type="button" class="custom_add custom_adds<?php echo $key?>" value="+"></input><input size="10" type="text" name="c_types[<?php echo $key?>][]" value="<?php echo $val[1]['c_type']?>"/></dt>
                                        <?php foreach($val as $keys=>$vals){?>
										<?php if($keys==1){?>
                                        <dd>
                                            <ul>
                                                <li><input type="text" name="c_details[<?php echo $key?>][]" value="<?php echo $vals['c_detail']?>"></li>
                                                <li><input type="text" name="c_nums[<?php echo $key?>][]" value="<?php echo $vals['c_num']?>"></li>
                                                <li><input type="text" name="c_prices[<?php echo $key?>][]" value="<?php echo $vals['c_price']?>"></li>
                                                <li><input type="text" name="c_omodels[<?php echo $key?>][]" value="<?php echo $vals['c_omodel']?>"></li>
                                                <li><input type="text" name="c_rbrands[<?php echo $key?>][]" value="<?php echo $vals['c_rbrand']?>"></li>
                                                <li><input type="text" name="c_rmodels[<?php echo $key?>][]" value="<?php echo $vals['c_rmodel']?>"></li>
                                                <li><input type="text" name="c_costs[<?php echo $key?>][]" value="<?php echo $vals['c_cost']?>"></li>
        ...
        <dl id="detail">
          ...
          <dd nc_type="no_spec">
            <!--<p>
             <textarea rows="10" style="width:300px;" name="d_specid" id="d_specid"><?php echo unserialize($output['goods']['d_specvalue']); ?></textarea>
            </p>-->
            <div class="custom_container">
                                <div class="custom_display">
                                    <dl >
                                        <dt><input type="button" class="custom_reduce" value="-"></input></dt>
                                        <dd>
                                            <ul>
                                                <li><input type="text" name="c_detail[]" value=""></li>
                                                <li><input type="text" name="c_num[]" value=""></li>
                                                <li><input type="text" name="c_price[]" value=""></li>
                                                <li><input type="text" name="c_omodel[]" value=""></li>
                                                <li><input type="text" name="c_rbrand[]" value=""></li>
                                                <li><input type="text" name="c_rmodel[]" value=""></li>
                                                <li><input type="text" name="c_cost[]" value=""></li>
                                ...
                                <?php if($car_detail){?>	
                                     <dl>
                                        <dt><input type="button" class="custom_add" value="+"></input><input type="text" size="10" name="c_type[]" value="<?php echo $car_detail[1]['c_type']?>"/></dt>								
                                        
										<?php foreach($car_detail as $key=>$val){?>
										<?php if($key==1){?>
                                        <dd>
                                            <ul>
                                               <li><input type="text" name="c_detail[]" value="<?php echo $val['c_detail']?>"></li>
                                                <li><input type="text" name="c_num[]" value="<?php echo $val['c_num']?>"></li>
                                                <li><input type="text" name="c_price[]" value="<?php echo $val['c_price']?>"></li>
                                                <li><input type="text" name="c_omodel[]" value="<?php echo $val['c_omodel']?>"></li>
                                                <li><input type="text" name="c_rbrand[]" value="<?php echo $val['c_rbrand']?>"></li>
                                                <li><input type="text" name="c_rmodel[]" value="<?php echo $val['c_rmodel']?>"></li>
                                                <li><input type="text" name="c_cost[]" value="<?php echo $val['c_cost']?>"></li>
                                            </ul>
                                        </dd>
                                    </dl>
                                    	<?php }else{?>
                                    ...
                                    <?php }?>
                                     ...
                                     <?php }else{?>
                                      <dl >
                                        <dt><input type="button" class="custom_add" value="+"></input><input type="text" size="10" name="c_type[]" value=""/></dt>				
                                        <dd>
                                            <ul>
                                                <li><input type="text" name="c_detail[]" value=""></li>
                                                <li><input type="text" name="c_num[]" value=""></li>
        ...
        <?php }?>
          ...
          <!--市场价格-->
        <dl>
          <dt nc_type="no_spec" ><?php echo $lang['store_market_price'];?></dt>
          <dd nc_type="no_spec">
            <p>
              <input name="market_price"  value="<?php echo $output['goods']['market_price']; ?>" type="text"  class="text"  />
            </p>
        ...
        <dl>
          <dt nc_type="no_spec"><span class="red">*</span><?php echo $lang['store_goods_index_stock_base'].$lang['nc_colon'];?></dt>
          <dd  nc_type="no_spec">
            <p>
              <input name="store_base" value="<?php echo $output['store_base']; ?>" type="text"  class="text" />
            </p>
          </dd>
        </dl>
       ...
       <?php if(is_array($output['attr_list']) && !empty($output['attr_list'])){?>
        ...
        <dl>
      	...
      	<?php if($_SESSION['store_id'] != 20){?>   
        <dl>
          <dt><?php echo $lang['store_goods_mail'].$lang['nc_colon'];?></dt>
          <dd>
           <select name="goods_mail" class="select-brand">
   	
                                <?php 	
								if($output['goods']['goods_mail'] == 1){
								
								?>
								  <option value="1">国内保税区仓库</option>
                                    <option value="2">境外仓库</option>
                                  <?php 
								 }elseif($output['goods']['goods_mail'] == 2){
								  ?>
                                  <option value="2">境外仓库</option>
                                   <option value="1">国内保税区仓库</option>
                                  <?php 
        ...
        <dl>
          ...
          <dd>
            <p>
              <?php showEditor('goods_body',$output['goods']['goods_body'],'100%','400px','visibility:hidden;',"true",$output['editor_multimedia']);?>
            </p>
        ...
        <dl>
          ...
          <dd>
            <p><span class="new_add"><a href="javascript:void(0)" id="add_sgcategory" class=" mr10"><span><?php echo $lang['store_goods_index_new_class'];?></span></a> </span>
...
var spec_group_content = [<?php for ($i=0; $i<$output['sign_i']; $i++){if($i+1 == $output['sign_i']){echo "''";}else{echo "'',";}}?>];
var str = '';
var V = new Array();

<?php for ($i=0; $i<$output['sign_i']; $i++){?>
var spec_group_checked_<?php echo $i;?> = new Array();
var spec_group_content_<?php echo $i;?> = new Array();
<?php }?>
...
$(function(){
	...
	//alert($("#spec_table tr").index($("#spec_table tr")));
		into_array();
...
//	$('input[type="checkbox"]').click(function(){
		goods_stock_set();
		var inputArr = $('tbody[nc_type="spec_table"]').children("tr");
		var length = inputArr.length;
		var str='';
		//var strstr='';
//			for($i=0;$i<length;$i++){
//			  for(var key in spec_group_checked){  
//			  	if(strstr){
//					strstr+='-'+spec_group_content[key];
//				}else{
//					strstr+=spec_group_content[key];
//				}
//			  }
			
				// str+='<p><textarea rows="10" style="width:300px;" name="d_specids[]"></textarea></p>';
				//str+='<div class="custom_container">'+strstr+'<div class="custom_display"><dl ><dt><input type="button" class="custom_reduce" value="-"></input></dt><dd><ul><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li></ul></dd></dl></div><dl><dt><input type="button" class="custom_add" value="+"></input></dt><dd><ul><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li><li><input type="text" name="" value=""></li></ul></dd></dl></div>';
			//}
			
			<?php goodsdetail(0,$output['sign_i']);?>
			$("#mingxiarr").html(str); 
			var detailarr=new Array();
				$(".qqqqqqqqqqqqqq .custom_add").click(function(){
					$(this).parents(".qqqqqqqqqqqqqq").append($(this).parents("dl").prev(".wwwwwwwwwwwwwwwwww").html());
				});
				$(document).delegate(".qqqqqqqqqqqqqq .custom_reduce",'click',function(){
...
//				eval("var aa"+i+"="+detailarr[i]);
//				
//				$('.custom_containers'+eval("aa"+i)+' input.custom_adds'+eval("aa"+i)).click(function(){
//					$(this).parent().parent().append($('.custom_displays'+eval("aa"+i)).html());
//				});
//				$(document).delegate('.custom_reduces'+eval("aa"+i),'click',function(){
//					$(this).parent().parent().remove();
//				});
//			}
...
<?php for ($i=0; $i<$output['sign_i']; $i++){?>
		...
		spec_group_content_<?php echo $i;?> = new Array();
		$('dl[nc_type="spec_group_dl_<?php echo $i;?>"]').find('input[type="checkbox"]:checked').each(function(){
			...
			spec_group_content_<?php echo $i;?>[spec_group_content_<?php echo $i;?>.length] = v;
		});

		spec_group_checked[<?php echo $i;?>] = spec_group_checked_<?php echo $i;?>;
		spec_group_content[<?php echo $i;?>] = spec_group_content_<?php echo $i;?>;
...
function recursionSpec($len,$sign) {
	if($len < $sign){
		...
		for($i=0; $i< $len; $i++){
			...
			echo "str +='<td><input class=\"text\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /></td><td><input class=\"text\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\"   value=\"\" /></td><td><input class=\"text\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\"  nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><input class=\"text\" type=\"text\" name=\"spec['+spec_bunch+'][market_price]\"  nc_type=\"'+spec_bunch+'|market_price\" value=\"\" /></td></tr>';\n";
		for($i=0; $i< $len; $i++){
			echo "}\n";
		}
	}
...
//生成产品明细
function goodsdetail($len,$sign){

	
	
	if($len < $sign){
		echo "for (var i_".$len."=0; i_".$len."<spec_group_checked[".$len."].length; i_".$len."++){valuecontent_".(intval($len)+1)." = spec_group_checked[".$len."][i_".$len."];\n";
		$len++;
		goodsdetail($len,$sign);
	}else{
		echo "var spec_name_content = '';\n";
		echo "var spec_name_id = 'i_';\n";
		for($i=0; $i< $len; $i++){
			echo "if(spec_name_content){spec_name_content += '-'+valuecontent_".($i+1)."[0];}else{spec_name_content += valuecontent_".($i+1)."[0];}\n";
			echo "spec_name_id += valuecontent_".($i+1)."[1];\n";
		}
		echo "str +='<div class=\"custom_containers'+spec_name_id+' qqqqqqqqqqqqqq\">'+spec_name_content+'<div class=\"custom_displays'+spec_name_id+' wwwwwwwwwwwwwwwwww\"><dl ><dt><input type=\"button\" class=\"custom_reduce custom_reduces'+spec_name_id+'\" value=\"-\"></input></dt><dd><ul><li><input type=\"text\" name=\"c_details['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_nums['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_prices['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_omodels['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_rbrands['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_rmodels['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_costs['+spec_name_id+'][]\" value=\"\"></li></ul></dd></dl></div><dl><dt><input type=\"button\" class=\"custom_add custom_adds'+spec_name_id+'\" value=\"+\"><input size=\"10\" type=\"text\" name=\"c_types['+spec_name_id+'][]\" value=\"\"/>	</input></dt><dd><ul><li><input type=\"text\" name=\"c_details['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_nums['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_prices['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_omodels['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_rbrands['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_rmodels['+spec_name_id+'][]\" value=\"\"></li><li><input type=\"text\" name=\"c_costs['+spec_name_id+'][]\" value=\"\"></li></ul></dd></dl></div>';\n";
...
//生成明细JS
function goodsdetailjs($len,$sign){
	...
	if($len < $sign){
		echo "for (var i_".$len."=0; i_".$len."<spec_group_checked[".$len."].length; i_".$len."++){valuecontent_".(intval($len)+1)." = spec_group_checked[".$len."][i_".$len."];\n";
		$len++;
		goodsdetailjs($len,$sign);
	}else{
		
			echo "var spec_name_id= 'i_';\n";
			for($j=0; $j< $len; $j++){
				echo "spec_name_id += valuecontent_".($j+1)."[1];\n";
			}
		
		echo "
				$('.custom_containers'+spec_name_id+' input.custom_adds'+spec_name_id).click(function(){
					$(this).parent().parent().append($('.custom_displays'+spec_name_id).html());
				});
				$(document).delegate('.custom_reduces'+spec_name_id,'click',function(){
					$(this).parent().parent().remove();
				});";
...
$(function(){
	...
	$('dl[nctype="spec_group_dl"]').find('input[type="checkbox"]').click(function(){
		...
		if(typeof(pv.find('input').val()) == 'undefined'){
			pv.html('<input type="text" maxlength="200" value="'+pv.html()+'" />');
		}else{
...
/**function goods_article_nums(my){
	
        var title =my.attr('dialog_title') ? my.attr('dialog_title') : '';
      
        var width = my.attr('dialog_width');
		var id = my.attr('name');
		var url = "index.php?act=store_goods&op=goods_records_list<?php if( $output['goods']['gc_id'] !=""){echo '&gc_id='. $output['goods']['gc_id'];}else{echo '&goods_records_id='.$_GET['id'];}?>&name="+id;
...
$(function(){
	...
	$('#detail').hide();
		...
		if (!(typeof(E_SP[s]) == 'undefined')){
			...
			if(E_SP[s] != ''){
				$(this).val(E_SP[s]);
				v.html('<input type="text" maxlength="200" value="'+E_SP[s]+'" />');
			}else{
				v.html('<input type="text" maxlength="200" value="'+v.html()+'" />');
			}
			change_img_name($(this));			// 修改相关的颜色名称
		}
	});
...
$(function(){
	// 增加
	var muban = $(".custom_display").html();
	
	$(".custom_container input.custom_add").click(function(){
		$(this).parent().parent().append(muban);
	});
	
	// 减少
	$(document).delegate(".custom_reduce","click",function(){
		$(this).parent().parent().remove();
	});
