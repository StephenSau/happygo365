<link rel="stylesheet" type="text/css" href="<?php echo TEMPLATES_PATH;?>/css/member.css">
<link rel="stylesheet" type="text/css" href="<?php echo TEMPLATES_PATH;?>/css/base.css">
<div class="eject_con">
  <div id="warning"></div>
  <dl>
  ...
  <dl>
    <dt><?php echo $lang['return_store_name'].$lang['nc_colon'];?></dt>
    <dd><?php echo $output['return']['store_name']; ?> </dd>
  </dl>
  <dl>
    <dt><?php echo $lang['return_state'].$lang['nc_colon'];?></dt>
    <dd> <?php echo $output['state_array'][$output['return']['return_state']]; ?> </dd>
  </dl>
  <dl>
  ...
  <?php if ($output['return']['return_state'] > 1) { ?>
  <dl>
  ...
  <table class="ncu-table-style order bc mt20 mb10" style="width:96%;">
    ...
    <tbody>
      ...
      <tr><td class="bdl w10"></td><td><div class="goods-pic-small"><span class="thumb size60"><i></i><a target="_blank" href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>"><img src="<?php echo thumb($val,'tiny'); ?>" onload="javascript:DrawImage(this,60,60);" /></a></span></div></td>
        ...
        <td class="bdl bdr" style="text-align:center;padding-top:30px;"><?php echo $val['goods_returnnum']; ?></td>
      </tr>
      <?php } } ?>
    </tbody>
  </table>
