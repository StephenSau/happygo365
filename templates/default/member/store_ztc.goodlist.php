...
<div class="wrap">
    ...
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="w80"><select name="goods_type">
            ...
            <option value="goods_open" <?php if($_GET['goods_type'] == 'goods_open') { ?>selected="selected"<?php } ?>><?php echo $lang['store_ztc_glist_goodsshow']; ?></option>
            <option value="goods_close" <?php if($_GET['goods_type'] == 'goods_close') { ?>selected="selected"<?php } ?>><?php echo $lang['store_ztc_glist_goodsunshow']; ?></option>
            <option value="goods_commend" <?php if($_GET['goods_type'] == 'goods_commend') { ?>selected="selected"<?php } ?>><?php echo $lang['store_ztc_glist_goodsrecommend']; ?></option>
            <option value="goods_ban" <?php if($_GET['goods_type'] == 'goods_ban') { ?>selected="selected"<?php } ?>><?php echo $lang['store_ztc_glist_goodslock']; ?></option>
          </select></td>
  ...
  <table class="ncu-table-style">
    <thead>
      <tr>
        <th></th>
        <th><?php echo $lang['store_ztc_goodsname']; ?></th>
        <th><?php echo $lang['store_ztc_glist_goldresidue'];?></th>
        <th><?php echo $lang['store_ztc_starttime']; ?></th>
        <th><?php echo $lang['store_ztc_glist_goodsshow']; ?></th>
        <th><?php echo $lang['store_ztc_glist_goodsrecommend']; ?></th>
        <th><?php echo $lang['store_ztc_glist_goodslock']; ?></th>
        <th><?php echo $lang['store_ztc_gstate_ztc']; ?></th>
      </tr>
    </thead>
