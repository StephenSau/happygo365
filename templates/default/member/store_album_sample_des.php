<div class="goods-gallery"> <a class="sample_demo" id="select_s" href="index.php?act=store_album&op=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>

  <div class="nav1"><span class="l"><?php echo $lang['store_goods_album_users'];?> >
  ...
  <ul class="list">
    ...
    <li onclick="insert_editor('<?php echo cthumb($v['apic_cover'],'max',$_SESSION['store_id']);?>');"><a href="JavaScript:void(0);"><span class="thumb size90"><i></i><img src="<?php echo cthumb($v['apic_cover'],'tiny',$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,90,90);" title='<?php echo $v['apic_name']?>'/></span></a></li>
