<div class="eject_con gselector">
  <div id="warning"></div>
    ...
    <dl>
      <dt><?php echo $lang['store_ztc_goodsname'].$lang['nc_colon']; ?></dt>
      <dd>
        <p>
          <input class="w300 text" type="text" id="stc_goods_name"/>
        </p>
        <p class="hint"><?php echo $lang['store_ztc_add_goods_searchtip'];?></p>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['store_ztc_add_storegoodsclass'].$lang['nc_colon']; ?></dt>
      <dd>
