        ...
        <dl>
          ...
          <dd>
            <p>
              ...
              <span class="field_notice"><a target="_blank" href="index.php?act=document&code=real_name"><?php echo $lang['store_create_true_name_intro'];?>?</a></span></p>
        ...
        <dl>
          ...
          <dd>
            <p>
              ...
              <span class="field_notice"><a target="_blank" href="index.php?act=document&code=real_store"><?php echo $lang['store_create_true_store_intro'];?>?</a></span></p>
            <p class="hint"><?php echo $lang['store_create_upload_rule'];?></p>
          </dd>
        </dl>
        <dl class="bottom">
          ...
          <dd>
            <p class="mb10">
              ...
              <label for="notice"><?php echo $lang['store_create_read_agreement1'];?><a href="index.php?act=document&code=open_store" target="_blank"><?php echo $lang['store_create_store_agreement'];?></a><?php echo $lang['store_create_read_agreement2'];?></label>
            <span></span> </p>
            <p class="mb10">
