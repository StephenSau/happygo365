<div class="eject_con">
  <div id="warning"></div>
  <form id="post_form" method="post" action="index.php?act=member_change&op=add&order_id=<?php echo $output['order']['order_id']; ?>">
    ...
    <table class="order ncu-table-style bc mt20" style="width:96%;" >
      <tbody>
        <tr>
          ...
          <th class="tc"><?php echo $lang['change_number'];?></th>
        </tr>
    ...
    <dl>
      <dt class="required"><em class="pngFix"></em><?php echo $lang['change_buyer_message'].$lang['nc_colon'];?></dt>
      <dd>
    ...
    $('#post_form').validate({
        ...
        invalidHandler: function(form, validator) {
         ...
         submitHandler: function(form) {
	        ...
	        messages : {
            buyer_message  : {
                required   : '<?php echo $lang['return_buyer_change_message_null'];?>'
            },
	        <?php if(is_array($output['order_goods_list']) && !empty($output['order_goods_list'])) {
							foreach($output['order_goods_list'] as $val) {
					?>
