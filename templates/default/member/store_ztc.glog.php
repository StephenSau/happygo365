  ...
  <table class="ncu-table-style">
      <thead>
        <tr nc_type="table_header">
          <th><?php echo $lang['store_ztc_list_number']; ?></th>
          <th><?php echo $lang['store_ztc_goodsname']; ?></th>
          <th><?php echo $lang['store_ztc_glog_list_goldnum']; ?></th>
          <th><?php echo $lang['store_ztc_glog_recordtype']; ?></th>
          <th><?php echo $lang['store_ztc_addtime']; ?></th>
          <th><?php echo $lang['store_ztc_glog_list_desc']; ?></th>
        </tr>
      </thead>
