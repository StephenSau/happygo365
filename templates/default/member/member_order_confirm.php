<div class="eject_conq">
  ...
  <form action="index.php?act=member&op=change_state&state_type=confirm_order&order_id=<?php echo $output['order_id']; ?>" method="post" id="confirm_order_form" onsubmit="ajaxpost('confirm_order_form','','','onerror')">
    ...
    <dl>
      <dt class="hdtq"><?php echo $lang['member_change_order_no'].$lang['nc_colon'];?></dt>
      <dd><span class="numq"><?php echo trim($_GET['order_sn']); ?></span></dd>
    </dl>
    <dl>
      <p class="hintq"><?php echo $lang['member_change_receive_tip'];?></p>
    </dl>
    <dl class="bottomq">
      <dt>&nbsp;</dt>
      <dd>
