  ...
  <div class="adds">
    ...
    <form method="post" action="index.php?act=deliver&op=buyer_address&order_id=<?php echo $_GET['order_id'];?>" id="address_form" target="_parent">
      ...
      <dl>
        ...
        <dt class="required"><?php echo $lang['store_show_order_card'];?></dt>

        <dd>

          <input type="text" class="text" name="card" id="card" value="<?php echo $output['address']['consignee_id_num'];?>"/>
...
$(document).ready(function(){
	...
	$('#ebutton').bind('click',function(){
		...
		var content = '<strong class="fl"><?php echo $lang['store_deliver_buyer_adress'].$lang['nc_colon'];?></strong>'+$('#sarea_info').val()+'&nbsp;'+$('#saddress').val()+'&nbsp;'+$('#szip_code').val()+'&nbsp;'+$('#strue_name').val()+'&nbsp;'+$('#stel_phone').val()+'&nbsp;'+$('#smob_phone').val()+'&nbsp;'+$('#scard').val();
