...
<div id="seller_groupbuy_form" class="wrap">
  ...
  <div class="ncu-form-style">
    <form method="post" id='ztc_form' action="index.php?act=store_ztc&op=edit_ztc&z_id=<?php echo intval($_GET['z_id']);?>">
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_ztc_add_choose_goods'].$lang['nc_colon'];?></dt>
        <dd>
      ...
      <dl>
        ...
        <dd>
          ...
          &nbsp;&nbsp;<?php echo $lang['store_ztc_add_havegold_text']; ?>&nbsp;<font style="font-weight:bold;"><?php echo $output['member_array']['member_goldnum'];?></font>&nbsp;<?php echo $lang['store_ztc_goldunit']; ?>
      ...
      <?php } ?>
      <dl id="group_intro">
        <dt> <?php echo $lang['store_ztc_add_remark']; ?>:</dt>
        <dd>
