...
<div class="wrap">
  ...
  <?php if($_GET['payment_code']=='yinlianbank'):?>

  <div class="ncu-form-style">

    <div id="warning"></div>

    <form method="post" action="index.php?act=store&op=add_payment&submit=ok" target="_parent">
	  ...
	  <dl>
		...
		<dt class="required">银联证书</dt>

		<dd>

			<a href="javascript:void(0);" onclick="window.upload.document.upload.file.click()">上传银联证书</a>&nbsp;&nbsp;&nbsp;<span id="location"></span>

			<iframe name="upload" src="index.php?act=store&op=store_yinlian&payment_code=<?php echo $_GET['payment_code']?>" style="display:none;" ></iframe>

			<input id="yinlian" type="hidden" name="yinlian" value="" /><span id="yinlian2"></span>
	  ...
	  <dl>
		...
		<dt class="required">商户证书</dt>

		<dd>

			<a href="javascript:void(0);" onclick="window.upload1.document.upload.file.click()">上传商户证书</a>&nbsp;&nbsp;&nbsp;<span id="location"></span>

			<iframe name="upload1" src="index.php?act=store&op=store_shanghu&payment_code=<?php echo $_GET['payment_code']?>" style="display:none;" ></iframe>

			<input id="shanghu" type="hidden" name="shanghu" value="" /><span id="shanghu2"></span>
