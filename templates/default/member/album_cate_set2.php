...
<div class="wrap">
  ...
  <div id="pictureIndex">
    ...
    <div class="picture-control">
     <!--相册创建-->
	 <div class="newalbum">
	  <a uri="index.php?act=store_album&op=album_add&id=<?php echo $_GET['id']?>" nc_type="dialog" dialog_title="<?php echo $lang['album_class_add'];?>" class="btn" ><?php echo $lang['album_class_add'];?></a>
	  </div>
	  <!--排序-->
      <div class="sortord">
     ...
     <!--上传图片-->
	  <div id="open_uploader" class="upload">
	  <a href="JavaScript:void(0);" class="hide"><?php echo $lang['album_class_list_img_upload'];?></a>
	  </div>
