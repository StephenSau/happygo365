<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=member_refund&op=offline_add&order_id=<?php echo $output['order']['order_id']; ?>">
    ...
    <dl style="margin-left:50px;margin-top:20px;margin-bottom:10px;font-size:16px;">
      <dt style="float:left;"><?php echo $lang['refund_order_amount'].$lang['nc_colon'];?></dt>
      <dd><?php echo ncPriceFormat($output['order']['order_amount']); ?></dd>
    </dl>
    <dl style="margin-left:50px;margin-top:20px;margin-bottom:10px;font-size:16px;">
      <dt class="required" style="float:left;"><em class="pngFix"></em><?php echo $lang['refund_order_refund'].$lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl style="margin-left:50px;margin-top:20px;margin-bottom:10px;font-size:16px;">
      <dt class="required" style="float:left;"><em class="pngFix"></em><?php echo $lang['refund_buyer_message'].$lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl style="margin-left:50px;margin-top:20px;margin-bottom:10px;font-size:16px;">
      <dt>&nbsp;</dt>
      <dd>
        <p class="hint" style="line-height:30px;"><?php echo $lang['refund_offline_buyer_desc'];?></p>
      </dd>
    </dl>
    <dl class="bottom" style="margin-left:50px;margin-top:20px;margin-bottom:10px;font-size:16px;">
      <dt>&nbsp;</dt>
      <dd>
