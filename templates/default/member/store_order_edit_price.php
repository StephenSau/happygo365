  ...
  <form id="changeform" method="post" action="index.php?act=store&op=change_state&state_type=store_order_edit_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      ...
      <dd>
        ...
        <input type="text" class="text" id="order_amount" name="order_amount" value="<?php echo ($output['order_info']['order_amount']-$output['order_info']['shipping_fee']); ?>"/>

      </dd>

    </dl>
     <dl>
      <dt><?php echo $lang['store_order_shinpping'].$lang['nc_colon'];?></dt>
      <dd>
