...
<div class="wrap">
  ...
  <form method="get" action="index.php" target="_self">
    <table class="search-form">
      ...
      <?php if (trim($_GET['state'])!='') { ?>
      <input type="hidden" name="state" value="<?php echo trim($_GET['state']); ?>" />
      <?php } ?>
      
      
      <tr>
      <?php if($_GET['state']=="delivering"){?>
        <td><a class="btns" href="index.php?act=deliver&op=index&state=delivering&add_time_from=<?php echo $_GET['add_time_from'];?>&add_time_to=<?php echo $_GET['add_time_to'];?>&excel=1"><span><?php echo $lang['store_order_export'];?></span></a></td>
        <?php }?>
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><a href="index.php?act=member_orderprint&order_id=<?php echo $val['order_id'];?>" target="_blank" class="fr" title="<?php echo $lang['store_show_order_printorder'];?>"/><i class="print-order"></i></a><span class="fr mr30"></span><span class="ml5"><?php echo $lang['store_order_order_sn'].$lang['nc_colon'];?><span class="goods-num"><?php echo $val['order_sn']; ?></span> <span class="ml20"><?php echo $lang['store_order_add_time'].$lang['nc_colon'];?><em class="goods-time"><?php echo date("Y-m-d H:i:s",$val['add_time']); ?></em></span> <span class="ml20">
          ...
          <?php }?>
          <?php if ($val['print']==1){?>
          <a href='index.php?act=deliver&op=print_deliver&order_sn=<?php echo $val['order_sn']; ?>' class="nc-show-deliver"><i></i><?php echo $lang['store_order_show_deliver_print'];?></a>
          <?php }?>
          </span></th>
      </tr>
      ...
      <tr>
        ...
        <td class="bdl bdr order-info w400" rowspan="<?php echo count($val['goods']);?>"><dl>
          ...
          <dl>
            ...
            <dd class="ts"><span><?php echo $val['area_info_order'];?><?php echo $val['address'].$lang['nc_comma'];?></span><span class="ml5"><?php echo $val['zip_code'].$lang['nc_comma'];?></span><span class="ml5"><?php echo $val['true_name'].$lang['nc_comma'];?></span><span class="ml10"><?php echo $val['tel_phone'];?></span><span class="ml10"><?php echo $val['mob_phone'];?></span></dd>
          </dl>
          <dl>
